...
ylabel_01 = r'$|u(x,t_0)|^2$'
ylabel_11 = r'$|u(x,t_1)|^2$'
ylabel_21 = r'$|u(x,t_2)|^2$'
ylabel_31 = r'$|u(x,t_3)|^2$'
ylabel_41 = r'$|u(x,t_4)|^2$'
ylabel_51 = r'$|u(x,t_5)|^2$'
ylabel_61 = r'$|u(x,t_6)|^2$'
ylabel_71 = r'$|u(x,t_7)|^2$'
ylabel_81 = r'$|u(x,t_8)|^2$'
...
ax_40.set_ylim(y_min, y_max)

ax_40.set_xticks(x_ticks_major, minor=False)
ax_40.set_xticks(x_ticks_minor, minor=True)

ax_40.set_yticks(y_ticks_major, minor=False)
ax_40.set_yticks(y_ticks_minor, minor=True)
...
ax_50.set_ylim(y_min, y_max)

ax_50.set_xticks(x_ticks_major, minor=False)
ax_50.set_xticks(x_ticks_minor, minor=True)

ax_50.set_yticks(y_ticks_major, minor=False)
ax_50.set_yticks(y_ticks_minor, minor=True)
...
ax_60.set_ylim(y_min, y_max)

ax_60.set_xticks(x_ticks_major, minor=False)
ax_60.set_xticks(x_ticks_minor, minor=True)

ax_60.set_yticks(y_ticks_major, minor=False)
ax_60.set_yticks(y_ticks_minor, minor=True)
...
ax_70.set_ylim(y_min, y_max)

ax_70.set_xticks(x_ticks_major, minor=False)
ax_70.set_xticks(x_ticks_minor, minor=True)

ax_70.set_yticks(y_ticks_major, minor=False)
ax_70.set_yticks(y_ticks_minor, minor=True)
...
ax_80.set_ylim(y_min, y_max)

ax_80.set_xticks(x_ticks_major, minor=False)
ax_80.set_xticks(x_ticks_minor, minor=True)

ax_80.set_yticks(y_ticks_major, minor=False)
ax_80.set_yticks(y_ticks_minor, minor=True)
...
ax_01.plot(x, np.abs(u_0)**2,     linewidth=linewidth_u,     linestyle=linestyle_u,     color=color_u,     label=label_u)

ax_01.set_xlim(x_min, x_max)
ax_01.set_ylim(y_min, y_max)
...
ax_01.set_yticks(y_ticks_minor, minor=True)
...
ax_11.plot(x, np.abs(u_1)**2,     linewidth=linewidth_u,     linestyle=linestyle_u,     color=color_u,     label=label_u)

ax_11.set_xlim(x_min, x_max)
ax_11.set_ylim(y_min, y_max)

ax_11.set_xticks(x_ticks_major, minor=False)
ax_11.set_xticks(x_ticks_minor, minor=True)

ax_11.set_yticks(y_ticks_major, minor=False)
ax_11.set_yticks(y_ticks_minor, minor=True)
...
ax_21.plot(x, np.abs(u_2)**2,     linewidth=linewidth_u,     linestyle=linestyle_u,     color=color_u,     label=label_u)

ax_21.set_xlim(x_min, x_max)
ax_21.set_ylim(y_min, y_max)

ax_21.set_xticks(x_ticks_major, minor=False)
ax_21.set_xticks(x_ticks_minor, minor=True)

ax_21.set_yticks(y_ticks_major, minor=False)
ax_21.set_yticks(y_ticks_minor, minor=True)
...
ax_31.plot(x, np.abs(u_3)**2,     linewidth=linewidth_u,     linestyle=linestyle_u,     color=color_u,     label=label_u)

ax_31.set_xlim(x_min, x_max)
ax_31.set_ylim(y_min, y_max)

ax_31.set_xticks(x_ticks_major, minor=False)
ax_31.set_xticks(x_ticks_minor, minor=True)

ax_31.set_yticks(y_ticks_major, minor=False)
ax_31.set_yticks(y_ticks_minor, minor=True)
...
ax_41.plot(x, np.abs(u_4)**2,     linewidth=linewidth_u,     linestyle=linestyle_u,     color=color_u,     label=label_u)

ax_41.set_xlim(x_min, x_max)
ax_41.set_ylim(y_min, y_max)

ax_41.set_xticks(x_ticks_major, minor=False)
ax_41.set_xticks(x_ticks_minor, minor=True)

ax_41.set_yticks(y_ticks_major, minor=False)
ax_41.set_yticks(y_ticks_minor, minor=True)
...
ax_51.plot(x, np.abs(u_5)**2,     linewidth=linewidth_u,     linestyle=linestyle_u,     color=color_u,     label=label_u)

ax_51.set_xlim(x_min, x_max)
ax_51.set_ylim(y_min, y_max)

ax_51.set_xticks(x_ticks_major, minor=False)
ax_51.set_xticks(x_ticks_minor, minor=True)

ax_51.set_yticks(y_ticks_major, minor=False)
ax_51.set_yticks(y_ticks_minor, minor=True)
...
ax_61.plot(x, np.abs(u_6)**2,     linewidth=linewidth_u,     linestyle=linestyle_u,     color=color_u,     label=label_u)

ax_61.set_xlim(x_min, x_max)
ax_61.set_ylim(y_min, y_max)

ax_61.set_xticks(x_ticks_major, minor=False)
ax_61.set_xticks(x_ticks_minor, minor=True)

ax_61.set_yticks(y_ticks_major, minor=False)
ax_61.set_yticks(y_ticks_minor, minor=True)
...
ax_71.plot(x, np.abs(u_7)**2,     linewidth=linewidth_u,     linestyle=linestyle_u,     color=color_u,     label=label_u)

ax_71.set_xlim(x_min, x_max)
ax_71.set_ylim(y_min, y_max)

ax_71.set_xticks(x_ticks_major, minor=False)
ax_71.set_xticks(x_ticks_minor, minor=True)

ax_71.set_yticks(y_ticks_major, minor=False)
ax_71.set_yticks(y_ticks_minor, minor=True)
...
ax_81.plot(x, np.abs(u_8)**2,     linewidth=linewidth_u,     linestyle=linestyle_u,     color=color_u,     label=label_u)

ax_81.set_xlim(x_min, x_max)
ax_81.set_ylim(y_min, y_max)

ax_81.set_xticks(x_ticks_major, minor=False)
ax_81.set_xticks(x_ticks_minor, minor=True)

ax_81.set_yticks(y_ticks_major, minor=False)
ax_81.set_yticks(y_ticks_minor, minor=True)
...
if export_pdf == True:
    ...
    filepath = path + "figure_finite_difference_dirichlet_crank_nicolson.pdf"
