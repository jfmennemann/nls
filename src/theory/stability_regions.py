...
# fontsize_titles_subfigures = "medium"
...
x = np.linspace(-4.0, 4.0, N+1, endpoint=True)
...
x_ticks_major = [-4, -2, 0, 2, 4]
x_ticks_minor = [-3, -1, 1, 3]
...
fig = plt.figure("figure_main", figsize=(8, 8), facecolor="white", constrained_layout=False)
        



gridspec = fig.add_gridspec(ncols=2, nrows=2, left=0.075, right=0.95, bottom=0.075, top=0.95, wspace=0.25, hspace=0.25, width_ratios=[1, 1], height_ratios=[1, 1])
